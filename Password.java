...
///////////////////////////////// CITATIONS ////////////////////////////////////
//
// https://canvas.wisc.edu/courses/355989/files/33238311?wrap=1
//
//
/////////////////////////////// 80 COLUMNS WIDE ////////////////////////////////
...
// could have been repeated, 1 billion
	/**
	 * Constructor for a new password object with the given password and number of
	 * occurrences.
	 *
	 * @param password,   the String that is the password
	 * @param occurences, the number of times the password has been used by people
	 * @throws IllegalArgumentException if the password is longer than the defined
	 *                                  MAX_LENGTH or empty OR the number of
	 *                                  occurrences is outside of the range
	 *                                  (0,MAX_OCCURRENCES]
	 * @author Michelle
	 */
	 ...
	 * lower bound for the minimum value. Used ONLY for implementation of front
	 * facing PasswordStorage.isValidBST() method.
	 *
	 * @return A password with all field values (used for comparisons) at their
	 *         minimum.
	 */
...
// long.
	...
	/**
	 * Creates a password objects with all fields (used for comparisons) at their
	 * upper bound for maximum value. Used ONLY for implementation of front facing
...
// long
	...
	/**
	 * Computes and sets the hashPassword by hashing the password using the SHA-1
	 * protocol into a string in hexadecimal. Code adapted from the following online
	 * resource: https://www.geeksforgeeks.org/sha-1-hash-in-java/
	 *
	 * @author Michelle
	 */
...
// exception
	...
	/**
	 * Computes a strength rating for the given string. Strength is determined by
	 * length and what kind of characters are used.
	 *
...
// if you want you can read up on regular expressions to decipher the strings I used
	...
	/**
	 * Determines if the argument object is equal to the current instance of a
	 * Password object.
	 *
	 * @param obj, the object to check to see if it is equal
	 * @return true if obj is a Password, occurrences, strength ratings, passwords,
	 *         and hashedPasswords are equal false otherwise
	 *
	 * @author Michelle
	 */
	@Override
	 ...
	 *
	 * @return The string representation in the form "PASSWORD (HASHED_PASSWORD):
	 *         OCURRENCES [STRENGTH_RATING]"
	 *
	 * @author Michelle
	 */
	@Override
	...
	/**
	 * Determines if the other password is less than, greater than, or equal to this
	 * password. The comparison will be made based on the attribute given.
	 *
	 * @param other the password object to compare to this one
	 * @param a     the data field to use when making the comparison.
	 * @return <0 if this is less than other, >0 if this is greater than other, and
	 *         0 if they are equal
	 *
	 * @author max liss
	 */
